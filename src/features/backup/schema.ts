...
/** `manifest.json` dentro da pasta do backup. `kind` é opcional para aceitar manifests antigos. */
...
export type BackupInfo = { id: string; createdAt: string; sizeBytes: number; kind: BackupKind };
